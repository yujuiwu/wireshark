...
*Wireshark* supports a wide variety of command line options.
...
*-z* wlan,connection[,<filter>]::
Show an IEEE 802.11 connection timeline with discovery, authentication,
association, key exchange, and disconnect events.
